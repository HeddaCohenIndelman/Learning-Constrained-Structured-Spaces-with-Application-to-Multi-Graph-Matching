...
__C.OPTIMIZATION_METHOD = 'Direct' #Direct or Sinkhorn
__C.MATCHING_TYPE = 'Unbalanced'
__C.filter_type = 'NoFilter'
__C.loss_epsilon = 3*1e-5
__C.pos_weight = 10
...
__C.lagrange_multiplier = -150
__C.penalty_method_on_cycle = True
__C.penalty_epoch_increase = 200


__C.normaliztion_On_SiameseSConvOnNodes = True
#__C.sinkhorn_on_rectangular = False #set dummy_row=False in sinkhorn
__C.no_sinkhorn_in_gnn = True
__C.normalize_gnn_outputs_channles= True # v = normalize_over_channels(v)
__C.twosided_diff_direct = True

#if __C.sinkhorn_anyhow:
#    __C.sigma_norm = 18

# Unbalanced settings
__C.source_partial_kpt_len = 30
__C.target_partial_kpt_len = 35

# Performing cross graph Sinkhorn normalization step or not
__C.crossgraph_s_normalization = False
...
__C.PROBLEM.SRC_OUTLIER = True

# Allow outlier in target graph. Useful for 2GM
__C.PROBLEM.TGT_OUTLIER = True
...
# Start learning rate
__C.TRAIN.LR = 0.01
#if __C.OPTIMIZATION_METHOD == 'Direct':
#    __C.TRAIN.LR =6*1e-4
...
__C.PRETRAINED_PATH = ''
#__C.PRETRAINED_PATH = 'output/vgg16_ngmv2_voc/params_Balanced_6_14_GConvNorma_FalseDirect_sample_35'
#__C.PRETRAINED_PATH = 'output/vgg16_ngmv2_voc/params_Balanced_6_14_GConvNorma_FalseDirect_sample_35'
#__C.PRETRAINED_PATH ='output/vgg16_ngmv2_voc/params_Balanced_6_14_GConvNorma_FalseSinkhorn_sample_35/params_0020.pt'
